...
function ce_template_scripts_styles() {
	...
	wp_register_script( 'js-main', get_template_directory_uri().'/assets/js/main.min.js', array('jquery') , '20140801', true );
	$themeUrl = get_stylesheet_directory_uri();
	$translation_array = array( 'themeUrl' => $themeUrl);
	wp_localize_script( 'js-main', 'objectUrl', $translation_array );
